Die Dokumentation erfolgt gtrennt nach den jeweiligen Aufgaben\hypertarget{_programmdokumentation_em_aufgabe1}{}\doxysubsection{Aufgabe I2\+C Lichtsensor}\label{_programmdokumentation_em_aufgabe1}
