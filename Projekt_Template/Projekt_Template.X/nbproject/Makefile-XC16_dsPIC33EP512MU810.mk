...
SOURCEFILES_QUOTED_IF_SPACED=code/configuration_bits.c code/interrupts.c code/main.c code/system.c code/traps.c code/user.c code/I2C.c code/UART.c code/lcd_gpio.c code/PMP.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/code/configuration_bits.o ${OBJECTDIR}/code/interrupts.o ${OBJECTDIR}/code/main.o ${OBJECTDIR}/code/system.o ${OBJECTDIR}/code/traps.o ${OBJECTDIR}/code/user.o ${OBJECTDIR}/code/I2C.o ${OBJECTDIR}/code/UART.o ${OBJECTDIR}/code/lcd_gpio.o ${OBJECTDIR}/code/PMP.o
POSSIBLE_DEPFILES=${OBJECTDIR}/code/configuration_bits.o.d ${OBJECTDIR}/code/interrupts.o.d ${OBJECTDIR}/code/main.o.d ${OBJECTDIR}/code/system.o.d ${OBJECTDIR}/code/traps.o.d ${OBJECTDIR}/code/user.o.d ${OBJECTDIR}/code/I2C.o.d ${OBJECTDIR}/code/UART.o.d ${OBJECTDIR}/code/lcd_gpio.o.d ${OBJECTDIR}/code/PMP.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/code/configuration_bits.o ${OBJECTDIR}/code/interrupts.o ${OBJECTDIR}/code/main.o ${OBJECTDIR}/code/system.o ${OBJECTDIR}/code/traps.o ${OBJECTDIR}/code/user.o ${OBJECTDIR}/code/I2C.o ${OBJECTDIR}/code/UART.o ${OBJECTDIR}/code/lcd_gpio.o ${OBJECTDIR}/code/PMP.o

# Source Files
SOURCEFILES=code/configuration_bits.c code/interrupts.c code/main.c code/system.c code/traps.c code/user.c code/I2C.c code/UART.c code/lcd_gpio.c code/PMP.c
...
${OBJECTDIR}/code/lcd_gpio.o: code/lcd_gpio.c  .generated_files/flags/XC16_dsPIC33EP512MU810/11d42cbeaa37dec4d203305ef4ece97c3d5bb205 .generated_files/flags/XC16_dsPIC33EP512MU810/63bb65385b9bcfd57ff63c9d0ae2a7c08640c179
	@${MKDIR} "${OBJECTDIR}/code" 
	@${RM} ${OBJECTDIR}/code/lcd_gpio.o.d 
	@${RM} ${OBJECTDIR}/code/lcd_gpio.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  code/lcd_gpio.c  -o ${OBJECTDIR}/code/lcd_gpio.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/code/lcd_gpio.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -DXPRJ_XC16_dsPIC33EP512MU810=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
...
${OBJECTDIR}/code/lcd_gpio.o: code/lcd_gpio.c  .generated_files/flags/XC16_dsPIC33EP512MU810/a38115a7711e0af41871c3871e8ebb9e4b9843b3 .generated_files/flags/XC16_dsPIC33EP512MU810/63bb65385b9bcfd57ff63c9d0ae2a7c08640c179
	@${MKDIR} "${OBJECTDIR}/code" 
	@${RM} ${OBJECTDIR}/code/lcd_gpio.o.d 
	@${RM} ${OBJECTDIR}/code/lcd_gpio.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  code/lcd_gpio.c  -o ${OBJECTDIR}/code/lcd_gpio.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/code/lcd_gpio.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_XC16_dsPIC33EP512MU810=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
