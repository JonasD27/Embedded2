...
${OBJECTDIR}/code/eeprom_25xx-1.o: code/eeprom_25xx-1.c  .generated_files/flags/XC16_dsPIC33EP512MU810/5a73294c1d6dd755f5eff999f6e8f489ea141b1c .generated_files/flags/XC16_dsPIC33EP512MU810/168b633b52a46c5b8b8a05feadf3c077d6e15a18
	@${MKDIR} "${OBJECTDIR}/code" 
...
${OBJECTDIR}/code/eeprom_25xx-1.o: code/eeprom_25xx-1.c  .generated_files/flags/XC16_dsPIC33EP512MU810/10ace2fc0e7db5ef49a9f389c15f092ad31107a6 .generated_files/flags/XC16_dsPIC33EP512MU810/168b633b52a46c5b8b8a05feadf3c077d6e15a18
	@${MKDIR} "${OBJECTDIR}/code" 
	@${RM} ${OBJECTDIR}/code/eeprom_25xx-1.o.d 
	@${RM} ${OBJECTDIR}/code/eeprom_25xx-1.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  code/eeprom_25xx-1.c  -o ${OBJECTDIR}/code/eeprom_25xx-1.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/code/eeprom_25xx-1.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_XC16_dsPIC33EP512MU810=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
