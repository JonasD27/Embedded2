...
Wenn es nichts mehr zu senden gibt, dann kommt es zum Restart und die Funktion FSM_Repeated_Start() wird aufgerufen. Hier wird wieder das Tranceive-Register mit der Adresse beschrieben. Wenn der Restart erfolgreich war, wird geschaut ob noch gelesen werden kann.
